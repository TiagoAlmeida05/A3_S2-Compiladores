...
public class CallParserTest extends JmmTestEnv {
    ...
    public void testMethodCallOnThis() {
        ...
        parseSnippet("this.foo(1, 2)", EXPRESSION);
    }
