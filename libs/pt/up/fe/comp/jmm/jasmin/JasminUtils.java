...
public class JasminUtils {
    ...
    public static File assemble(File inputFile, File outputDir) {
        ...
        try (FileInputStream fs = new FileInputStream(inputFile);
            ...
            throw new RuntimeException("JAS Error: " + e.getMessage() + "\nCode: " + SpecsIo.read(inputFile), e);
        } catch (Exception e) {
            throw new RuntimeException("Exception while assembling Jasmin file: " + e.getMessage() + "\nCode: " + SpecsIo.read(inputFile), e);
        }
